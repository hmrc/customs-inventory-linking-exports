...
trait CustomsMetricsService extends WireMockRunner {
  private val urlMatchingRequestPath = urlMatching(ExportsExternalServicesConfig.CustomsMetricsContext)

  def setupCustomsMetricsServiceToReturn(status: Int = OK): Unit =
