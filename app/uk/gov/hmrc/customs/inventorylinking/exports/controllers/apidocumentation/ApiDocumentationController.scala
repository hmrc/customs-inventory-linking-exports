...
package uk.gov.hmrc.customs.inventorylinking.exports.controllers.apidocumentation

import controllers.Assets
import play.api.Configuration
import play.api.http.MimeTypes
import play.api.mvc.{Action, AnyContent, ControllerComponents}
import uk.gov.hmrc.customs.inventorylinking.exports.controllers.documentation.DocumentationController
...
class ApiDocumentationController @Inject()(assets: Assets,
  ...
  def definition(): Action[AnyContent] = Action {
    Ok(uk.gov.hmrc.customs.inventorylinking.exports.views.txt.definition(v1Enabled, v2Enabled)).as(MimeTypes.JSON)
  }
}
